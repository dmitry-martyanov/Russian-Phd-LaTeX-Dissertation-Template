...
\begin{center}
    ...
    Автореферат диссертации на соискание ученой степени \par \thesisDegree{} \par по специальности \thesisSpecialtyNumber\ "--- \thesisSpecialtyTitle
    \par\bigskip

    Подписано в печать \blank[\widthof{999}].\blank[\widthof{999}].\blank[\widthof{99999}].
    Заказ № \blank[\widthof{999999999999}]

    Формат 60\(\times\)90/16. Усл. печ. л. \blank[\widthof{999}].  Уч.-изд. л. \blank[\widthof{999}]. Тираж \blank[\widthof{999}] экз.
